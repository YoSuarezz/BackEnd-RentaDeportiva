...
public class ActualizarTipoEspacioDeportivoFachadaImpl implements FacadeWithoutReturn<TipoEspacioDeportivoDTO> {
    ...
    public void ejecutar(TipoEspacioDeportivoDTO tipoEspacioDeportivo) {
        ...
        try {
            ...
            var mensajeUsuario = "Se ha presentado un errror tratando de editar el tipo de espacio deportivo";
            var mensajeTecnico = "Se ha presentado un problema inesperado tratando de editar la informacion del tipo de espacio deportivo en el metodo ejecutar de la clase ActualizarTipoEspacioDeportivoFachadaImpl. Por favor revise la traza completa del problema";
